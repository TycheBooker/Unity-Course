...
public class TextController : MonoBehaviour {
    ...
    {
        text.text = "Your are still in your cell, and STILL want to escapse! There are some dirty sheets on the bed, a mark where the mirror was, and that pesky door is still there, and firmly locked!\n\nPress S to view Sheets, or L to view Lock";
    ...
    void state_sheets_1()
    {
        text.text = "Holding a mirror in your hand doesn't make the sheets look and better.\n\nPress R to Return to roaming your cell";
        if (Input.GetKeyDown(KeyCode.R)) myState = States.cell_mirror;
    }

    void state_lock_0()
    {
        text.text = "This is one of those button locks. You have no idea what the combination is. You wish you could somehow see where the dirty fingerprints were, maybe that would help.\n\nPress R to Return to rooaming your cell";
        if (Input.GetKeyDown(KeyCode.R)) myState = States.cell;
    }

    void state_lock_1()
    {
        text.text = "You carefully put ht emirror through the bars, and turn it round so you can see the lock. You can just make out fingerprints around the buttons. You press the dirty buttons, and hear a click.\n\nPress O to Open, or R to Return to your cell";
